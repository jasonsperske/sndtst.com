...
!function(i){"use strict";var r={};i.SNDTST={init:function(a,t,n){$("#jplayer_1").jPlayer({ready:function(){r.dom=$(a),r.tracks={},$("li",r.dom).each(function(){var a=$(this).data("song");r.tracks[a]={oga:t+a+".ogg",mp3:t+a+".mp3"}}).on("click",function(){i.SNDTST.play($(this).data("song"))}).addClass("jp-playable"),n()},swfPath:"/static/js",supplied:"oga, mp3"}).on($.jPlayer.event.play,function(){var a=$("li[data-song="+$(this).data("current-track")+"]");$(".jp-playing-track").removeClass("jp-playing-track"),a.addClass("jp-playing-track"),$(".jp-title").html(a.data("title"))}).on($.jPlayer.event.ended,function(){var a=$("li.jp-playing-track").next();$(this).removeData("current-track"),void 0!==a&&i.SNDTST.play(a.data("song"))})},play:function(a){var t=a;void 0===t&&(t=$($("li",r.dom)[0]).data("song")),$("#jp_container_1").fadeIn(),$("#jplayer_1").data("current-track",t).jPlayer("setMedia",r.tracks[t]).jPlayer("play")}}}(window);