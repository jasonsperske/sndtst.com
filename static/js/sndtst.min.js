...
!function(a){"use strict";var t={};a.SNDTST={init:function(n,i,r){$("#jplayer_1").jPlayer({ready:function(){t.dom=$(n),t.tracks={},$("li",t.dom).each(function(){var a=$(this).data("song");t.tracks[a]={oga:i+a+".ogg",mp3:i+a+".mp3"}}).on("click",function(){a.SNDTST.play($(this).data("song"))}).addClass("jp-playable"),r()},swfPath:"/static/js",supplied:"oga, mp3"}).on($.jPlayer.event.play,function(){var a=$("li[data-song="+$(this).data("current-track")+"]");$(".jp-playing-track").removeClass("jp-playing-track"),a.addClass("jp-playing-track"),$(".jp-title").html(a.data("title"))}).on($.jPlayer.event.ended,function(){var t=$("li.jp-playing-track").next();$(this).removeData("current-track"),void 0!==t&&a.SNDTST.play(t.data("song"))})},play:function(a){var n=a;void 0===n&&(n=$($("li",t.dom)[0]).data("song")),$("#jp_container_1").fadeIn(),$("#jplayer_1").data("current-track",n).jPlayer("setMedia",t.tracks[n]).jPlayer("play")}}}(window);